      ...
      >
        ...
        >
          ...
          <ListItem button onClick={toggleMobileServicesDropdown}>
            <ListItemText primary="Services" sx={{ paddingLeft: '5px', color: isServicesActive() ? '#00e676' : 'inherit', }} />
            <ExpandMoreIcon />
          </ListItem>
          ...
          <Collapse in={languageOpen} timeout="auto" unmountOnExit>
            ...
            >
              {['English', 'Japanese', 'Tamil', 'Swedish', 'Chinese', 'Hindi', 'Kannada', 'Malayalam', 'Telugu'].map((languageOption) => (
                <MenuItem
                  key={languageOption}
                  onClick={() => handleLanguageChange(languageOption)}
                  sx={{
